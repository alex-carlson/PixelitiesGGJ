...
namespace Polybrush
{
	...
	public class z_BrushSettings : ScriptableObject, z_IHasDefault
	{
		...
		public void CopyTo(z_BrushSettings settings)
		{
			settings.brushRadiusMin = this.brushRadiusMin;
			settings.brushRadiusMax = this.brushRadiusMax;

			settings.radius = this.radius;
			settings.falloff = this.falloff;
			settings.strength = this.strength;
		}
	}
}
